...
testMatch: ["tests/02.recorded.test.ts"],       //specifices what file to test, can make a general folder path to test more.
use: {
    headless: false,
    screenshot: "only-on-failure",
    video: "retain-on-failure",
},
retries: 2,                                     //retries if failure. Helpful if for example page hasn't loaded.
